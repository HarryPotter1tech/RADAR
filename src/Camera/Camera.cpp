...
int CameraDriver::getCameraWidth() { return static_cast<int>(cap.get(cv::CAP_PROP_FRAME_WIDTH)); }
int CameraDriver::getCameraHeight() { return static_cast<int>(cap.get(cv::CAP_PROP_FRAME_HEIGHT)); }
} // namespace Camera
